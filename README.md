...
- You can use `adb shell am start -a android.intent.action.VIEW -d "https://aframe.io" io.portalvr.wolvic/com.igalia.wolvic.VRBrowserActivity` to load a URL from the command line
- You can use `adb shell am start -a android.intent.action.VIEW  -n io.portalvr.wolvic/com.igalia.wolvic.VRBrowserActivity -e homepage "https://example.com"` to override the homepage
